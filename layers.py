...
class Conv2D():
    def __init__(self, in_channel, out_channel, kernel_height, kernel_width, stride=1, activation = None, lr=0.001):
...
class TransposeConv2D():
    def __init__(self, in_channel, out_channel, kernel_height, kernel_width, stride=1, padding=-1, activation = None, lr=0.001):
        self.in_channel = in_channel
        self.out_channel = out_channel
        self.kernel_height = kernel_height
        self.kernel_width = kernel_width
